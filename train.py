...
csv_logger = CSVLogger('logs/training_set_iranalysis2.csv',separator=',', append=False)
model.fit(x_train, y_train, batch_size=32, nb_epoch=1000,callbacks=[checkpointer,csv_logger])
